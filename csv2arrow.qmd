...
Thus, the ease of creating and distributing a CSV file must be balanced against the difficulty and uncertainty of reading its contents, possibly into different language frameworks, such as [R](https://www.R-project.org), [Python](https://python.org) or [Julia](https://julialang.org).
...
csvnm = joinpath("data", "311_Service_Requests_2023_03.csv")
...
## Accessing the data from different environments
...
An alternative, using the `dplyr` package in the [tidyverse](https://tidyverse.org), is
