...
We import the Arrow data with Python package `polars`.
...
:   HTML output including the full output from running R and Python code
in Julia, generated from rending the quarto source (.html file).
