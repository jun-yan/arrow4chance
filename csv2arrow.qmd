...
Arrow file (less than 24 MB) compared to the original CSV file
...
NYC 311 service request data for May, 2023 as downloaded on July 25, 2023.

:   Data set used in the illustration (.csv file).
